/* $Id: dir.c 51197 2011-03-29 21:48:13Z fireball $
 *
        ...
        )
{
        ...
        BufferU.MaximumLength = (USHORT)min(nBufferLength * sizeof(WCHAR), USHRT_MAX);
        ...
        Buffer.MaximumLength = (USHORT)min(nBufferLength, USHRT_MAX);
